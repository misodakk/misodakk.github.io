...
{{< figure src="https://img.misoda.eu.org/file/1781405311457_2065346370085736576.webp" title="感觉自己萌萌哒" >}}
...
- 折腾 Python、PHP、JS/TS、Go、Linux、大前端等等大杂烩；期间把能知道的技术看了个遍.....额，是简单入门，我愿称为是大学闲得
- 开始主攻 Java Web 生态至今（其实就是 Spring 生态、微服务、JVM；架构摸索中、DevOps 摸索中）
- 开始对 JS/ES6 进行"深入"了解，对其评价很高（但是现在学不动了，只能到 ES6 了），对 Vue、React、小程序等生态感兴趣，搞过一些简单的跨平台方案，CI/CD 自动化等
- ~~想要深度学习 Py，对深度学习、LLM/AIGC 之类感兴趣，对图片模式识别和生成尤其感兴趣~~
- 慢慢地个人时间越来越少，现在也就折腾下 PVE、Homelab、K3S、NAS，~~都要成为网络专家了~~；Docker 部署了一堆东西，游戏玩的越来越少，要警惕电子阳痿
- 被逼开始研究 AI Coding 和 AIGC 生态
