...
国产现在 K3 和 GLM 5.2 评价不错，尤其是最近的 K3，不过价格比 GLM 要贵。
...
相关参考：[网络搜索模式](https://learn.chatgpt.com/docs/config-file/config-basic#web-search-mode)
