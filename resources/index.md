...
收集一些自己常用的**资源站**，不在多而在于精，理想条件下是一个网站解决一类需求，然后外加几个备用。
...
本页面可能会包含一些具体的软件和服务，但是主要以综合的**在线资源站为主**；

博主自用的**软件整理**请移步 [**我的软件清单&军火库**](/我的软件清单军火库/)，这个系列也会包含一些<del>穷鬼开发者【指可免费使用】</del>开发调试用到的一些可爱的环境提供服务商。
...
1. [魔搭社区](https://modelscope.cn/home)
1. [SkillHub](https://skillhub.cn/)
1. [MCP Market](https://mcpmarket.com/zh)
1. [MCP World](https://www.mcpworld.com/)
1. [趋近智](https://apxml.com/zh)

## {{< fa-icon solid rocket >}}其他
